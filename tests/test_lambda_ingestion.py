...
def dynamodb_table():
    ...
    with mock_aws():
        ...
        # The module-level `table` was bound before the mock started;
        # moto intercepts calls made through it as long as the mock
        # is active, so no monkeypatching is required here.
        yield table
